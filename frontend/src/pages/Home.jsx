  ...
  return (
    <div data-testid="home-page">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-20 md:py-32 grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-end">
          <div className="md:col-span-8 animate-fade-in-up">
            ...
            <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:flex sm:flex-wrap gap-3">
              ...
              <a
                href="/register"
                className="border border-foreground px-5 sm:px-6 py-3 text-center text-xs uppercase tracking-[0.24em] sm:tracking-[0.3em] font-bold hover:bg-foreground hover:text-background transition-colors"
      ...
      <section id="marketplace" className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 border-b border-border">
        ...
        {loading ? (
          <div className="text-center py-16 text-muted-foreground text-xs uppercase tracking-[0.3em]">
            Loading inventory...
          </div>
        ) : listings.length === 0 ? (
          <div className="text-center py-16 border border-border" data-testid="empty-state">
            ...
            <p className="text-muted-foreground text-sm mt-4">
              Be the first website owner to list banner inventory on BadAdz.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 border-b border-border" data-testid="trust-section">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border border border-border">
          <TrustCard
            ...
            text="Checkout runs through Stripe so payments are tracked before campaigns start."
          />

          <TrustCard
            icon={<Mail size={18} />}
            title="Owner Contact"
            text="Advertisers get the website owner's contact info after purchase."
          />

          <TrustCard
            icon={<CalendarDays size={18} />}
            title="30-Day Campaigns"
            text="Each placement is tracked as a fixed 30-day banner campaign."
          />

          <TrustCard
            icon={<Percent size={18} />}
            title="Transparent Fee"
            text="BadAdz takes 20%. Sellers keep 80%. No hidden platform math."
          />
        </div>
      </section>
    </div>
